      ...
      <Container>
        <Flex className={'flex flex-col lg:flex-row justify-between'}>
          ...
          <div className="">
            ...
            <h3 className="font-bold text-3xl lg:text-5xl font-Nunito lg:w-[755px] leading-[40px] lg:leading-[60px] pt-5">
              Best Digital Marketing Agency For People
            </h3>
            <p className="lg:w-[658px] text-gray font-DM_sans pt-5 lg:pt-10">
            ...
            <div className="pt-5 space-y-2 pb-10">
